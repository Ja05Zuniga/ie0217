...
# Configuracion de Hierarchical Clustering con enlace completo
...
# Configuracion de Hierarchical Clustering con scikit-learn
agg_clustering = AgglomerativeClustering(n_clusters=3) #Numero de clústeres
